...
- Enhanced Reports page with functional filters and real PDF export functionality
...
- Fixed Dashboard "Vendas Recentes" buttons - removed edit/delete, kept functional view button
